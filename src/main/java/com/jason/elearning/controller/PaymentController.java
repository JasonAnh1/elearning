...
//        resp.getWriter().write(gson.toJson(job));
    ...
    @GetMapping("v1/publish/pay2")
    public ResponseEntity<?> pay2(@RequestParam String bankCode,@RequestParam Long amountRequest) throws Exception {
